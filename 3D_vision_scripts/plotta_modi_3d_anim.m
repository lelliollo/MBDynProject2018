function plotta_modi_3d(coords,link,ODSs,nmode,Dof_exc,Dof_nodes,input_node,mag,exp_cycle)
...
deflections(:,1)=real(deflections_x*exp_cycle);
deflections(:,2)=real(deflections_y*exp_cycle);
deflections(:,3)=real(deflections_z*exp_cycle);
forzante=real(Dof_exc*exp_cycle);
